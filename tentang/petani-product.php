...
// query data komoditas berdasarkan NRP
$commodity = query("SELECT * FROM komoditas WHERE nrp = $NRP");

// tombol cari ditekan
if (isset($_POST["cari"])) {
  $commodity = cari($_POST["keyword"]);
}
?>
<!doctype html>
<html lang="en">
...
<head>
  ...
  <title>Toko Petani - Produk Member</title>
...
<body>
  ...
  <div class="tab-rekomendasi">
    <p class="container-special">Daftar Beras Dari Warung <?= $name ?></p>
  </div>
  <!-- end Info Panel -->
  <!-- Content List Barang-->
