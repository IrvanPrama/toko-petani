...
$daerah = query("SELECT * FROM daerah_petani");
$members = query("SELECT * FROM petani");
// tombol cari ditekan
if (isset($_POST["filter"])) {
    $members = filter($_POST["alamat"]);
}
?>
...
<body>
    ...
    <div class=" tab-rekomendasi text-rekomendasi">
        <div class="container">
            <form action="" method="post">
                <select data-container="body" data-toggle="popover" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." name="daerah" type="select" class="search">
                ...
                <button class="btn btn-primary tombol" type="submit" name="filter" data-toggle="popover" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">Cari</button>
            </form>
        </div>
    </div>
    <!-- AKhir Zona -->
    ...
    <div class="container">
        <?php foreach ($members as $member) : ?>
            <a href="member-produk.php?nrp=<?= $member["nrp"]; ?>&pemilik=<?= $member["pemilik"]; ?>" style="text-decoration: none; color:black;">
                <div class="row member-row">
                    <div class="img-profil-box">
                        <img src="php/img/<?= $member["profil"]; ?>" alt="Profil" class="profil">
                    </div>
                    <div class="description">
                        <p class="nm"><?= $member["nama"]; ?></p>
                        <p class="nm-2"><?= $member["alamat"]; ?></p>
                        <p class="nm-3"><?= $member["hp"]; ?></p>
                    </div>
                    <div class="show">
                        <img src="image/logo-morethan.png" class="morethan" alt="morethan">
                    </div>
                </div>
            </a>
        <?php endforeach; ?>
