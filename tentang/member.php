...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav ml-auto">
                    ...
                    <a class="nav-item nav-link" href="lists.html">Produk</a>
    ...
    <div class=" tab-rekomendasi text-rekomendasi">
        <p class="container zona-member">Jln. Dukuh Sari - Denpasar Selatan</p>
    </div>
    <!-- AKhir Zona -->
    ...
    <div class="container">
        ...
        <a href="zona.php?id=<?= $member["id"]; ?>" style="text-decoration: none; color:black;">
